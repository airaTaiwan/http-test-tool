...
const originalRunScriptPath = join(resolve(__dirname, '../packages/run/run.sh'))
...
copySync(originalRunScriptPath, newMacRunScriptPath, { overwrite: true })
...
copySync(originalRunScriptPath, newWindowRunScriptPath, { overwrite: true })
...
copySync(originalRunScriptPath, newUbuntuRunScriptPath, { overwrite: true })
